...
<div class="modal fade" style="position:abssolute" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
  <div class="modal-dialog" style="margin-top:80px;margin-bottom: 40px;">
    <div class="modal-content">
      ...
      <button type="button" on:click={whoami} class="btn">whoami</button>
      <button type="button" on:click={logout} class="btn">logout</button>
      </div>
    </center>
    {:else}
      <h1 class="mx-auto center text-center">Log in</h1>
      <br>
<form id="form" class="form my-3 w-50 text-left mx-auto">
          <div class="mb-3 text-left">
            <label for="text" class="form-label text-left">Username</label>
        ...
        <button type="button" on:click={login} class="btn">login</button>
      </form>
    {/if}
  </div>
